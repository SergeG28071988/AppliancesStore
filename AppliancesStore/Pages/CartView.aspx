<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CartView.aspx.cs" 
    Inherits="AppliancesStore.Pages.CartView"
...
<asp:Content ID="Content1" ContentPlaceHolderID="bodyContent" runat="server">
    <div id="content">
        ...
        <table id="cartTable">
            ...
            <tbody>
                <asp:Repeater ID="Repeater1" ItemType="AppliancesStore.Models.CartLine"
                    SelectMethod="GetCartLines" runat="server" EnableViewState="false">
                    <ItemTemplate>
                        <tr>
                            <td><%# Item.Quantity %></td>
                            <td><%# Item.Appliance.Name %></td>
                            <td><%# Item.Appliance.Price.ToString("c")%></td>
                            <td><%# ((Item.Quantity * 
                                Item.Appliance.Price).ToString("c"))%></td>
                             <td>
                                <button type="submit" class="actionButtons" name="remove"
                                    value="<%#Item.Appliance.ApplianceId %>">
                                    Удалить</button>
                            </td>
                        </tr>
                    </ItemTemplate>
