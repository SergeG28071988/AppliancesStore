<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Appliances.aspx.cs" 
    Inherits="AppliancesStore.Pages.Admin.Appliances" 
    MasterPageFile="~/Pages/Admin/Admin.Master" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:ListView ID="ListView1" ItemType="AppliancesStore.Models.Appliance" SelectMethod="GetAppliances"
        DataKeyNames="ApplianceId" UpdateMethod="UpdateAppliance" DeleteMethod="DeleteAppliance"
        InsertMethod="InsertAppliance" InsertItemPosition="LastItem" EnableViewState="false"
        runat="server">
        <LayoutTemplate>
        ...
        <EditItemTemplate>
            <tr>
                <td>
                    ...
                    <input type="hidden" name="ProductID" value="<%# Item.ApplianceId %>" />
                </td>
                <td>
